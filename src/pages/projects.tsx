    ...
    <Box>
      ...
      <Section>
        ...
        <Project title="Quiztastic" link="https://quiztastic.app">
          Web based trivia game for friends and family. Create games that can be
          joined by multiple people.
        </Project>
      ...
      <Section>
        ...
        >
          LSTM neural network trained to predict a Myers Brigg personality type
          based on some text.
        </Project>
