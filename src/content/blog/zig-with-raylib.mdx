...
Raylib is great and simple to use library for 2D graphics. But it took me a
while to figure out how to setup Zig with Raylib. So I thought I'd write up a
quick guide.
